...
3. Build the files using the command ```cobc -x -free   -o bin/incollege   src/incollege.cob src/create-account.cob src/login.cob src/create-profile.cob src/view-profile.cob src/connections.cob src/search-profile.cob src/post-job.cob src/browse-job.cob src/send-message.cob src/view-message.cob```
