                 ...
                 EVALUATE WS-RETURN-CODE
                     WHEN 'S'
                         *> Prompt user to manage the requests they just viewed
                         ...
                         PERFORM DISPLAY-AND-LOG
                         MOVE "2. No, go back to the main menu" TO WS-MESSAGE
                         PERFORM DISPLAY-AND-LOG
                         MOVE 1 TO MIN-VALUE-CHOICE
                         MOVE 2 TO MAX-VALUE-CHOICE
                         PERFORM CHOICE
